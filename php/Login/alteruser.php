...
if(isset(($_POST['telefone'])) && isset(($_POST['email'])) && isset(($_POST['senha'])) && isset(($_POST['nome']))){
  if(!empty(($_POST['telefone'])) || !empty(($_POST['email'])) || !empty(($_POST['senha'])) || !empty(($_POST['nome']))){
    @session_start();
    ...
    if(!empty(trim($_POST['nome']))){
      ...
      mysqli_query($db_connection,"UPDATE anotacoes SET nome = '$nomealterado' WHERE email='$user_email'");
    }
